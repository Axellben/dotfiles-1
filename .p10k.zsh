# Generated by Powerlevel10k configuration wizard on 2020-01-25 at 21:17 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 52061.
# Wizard options: awesome-fontconfig + powerline, large icons, rainbow, vertical separators, sharp heads, flat tails, 1 line, sparse, few icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=7
  ...
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND=4
  # Show battery in green when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=5
  # Show battery in yellow when it's discharging.
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=4
  # Battery pictograms going from low to high level of charge.
  typeset -g POWERLEVEL9K_BATTERY_STAGES=('  ' '  ' '  ' ' ' '  ')
  # Don't show the remaining time to charge/discharge.
  typeset -g POWERLEVEL9K_BATTERY_VERBOSE=off
